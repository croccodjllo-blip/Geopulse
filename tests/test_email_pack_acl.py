...
def test_email_pack_denied_for_org_viewer(monkeypatch):
    ...
    with app.app_context():
        ...
        if hasattr(owner, "welcome_credit_granted"):
            owner.welcome_credit_granted = True
        viewer = User(
        ...
        viewer.email_verified_at = datetime.now(timezone.utc)
        if hasattr(viewer, "welcome_credit_granted"):
            viewer.welcome_credit_granted = True
