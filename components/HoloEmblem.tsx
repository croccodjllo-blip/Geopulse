...
export function HoloEmblem({
  ...
  useEffect(() => {
    ...
    const color = (h: Particle["hue"]) =>
      h === "violet" ? "rgba(138,43,226,0.85)" : h === "blue" ? "rgba(0,102,255,0.8)" : "rgba(0,240,255,0.9)";
  ...
  return (
    <div
      className={
        className ||
        "relative inline-grid place-items-center rounded-full bg-[#080B10] shadow-[0_0_40px_rgba(0,240,255,0.22),0_0_80px_rgba(138,43,226,0.12)]"
      }
    ...
    >
      <svg
        ...
        width={size}
        height={size}
        className="relative z-[1] drop-shadow-[0_0_18px_rgba(0,240,255,0.35)]"
        aria-hidden
      >
        <defs>
          <linearGradient id={`${uid}-holo`} x1="20" y1="110" x2="108" y2="18" gradientUnits="userSpaceOnUse">
            <stop stopColor="#0066FF" />
            <stop offset="0.45" stopColor="#00F0FF" />
          ...
          <linearGradient id={`${uid}-metal`} x1="32" y1="96" x2="96" y2="28" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="0.5" stopColor="#00F0FF" stopOpacity="0.55" />
            <stop offset="1" stopColor="#8A2BE2" stopOpacity="0.35" />
          </linearGradient>
          <radialGradient id={`${uid}-core`} cx="50%" cy="58%" r="42%">
            <stop stopColor="#00F0FF" stopOpacity="0.95" />
            <stop offset="0.45" stopColor="#0066FF" stopOpacity="0.55" />
        ...
        <g className="origin-center animate-[spin_28s_linear_infinite]" style={{ transformOrigin: "64px 64px" }}>
          <ellipse cx="64" cy="64" rx="40" ry="16" stroke="#00F0FF" strokeOpacity="0.28" strokeWidth="0.9" transform="rotate(-28 64 64)" fill="none" />
          <ellipse cx="64" cy="64" rx="36" ry="14" stroke="#8A2BE2" strokeOpacity="0.22" strokeWidth="0.8" transform="rotate(38 64 64)" fill="none" />
        </g>
        ...
        <g filter={`url(#${uid}-glow)`} className="origin-center animate-[spin_18s_linear_infinite_reverse]" style={{ transformOrigin: "64px 72px" }}>
          ...
          <path d="M64 86c14-1 22-11 20-22s-12-17-22-15c-8 1.5-12.5 9.5-11 17" stroke="#0066FF" strokeWidth="1.2" strokeLinecap="round" fill="none" opacity="0.85" />
          <path d="M64 80c10 0 16-8 14.5-15.5S70 54 64 55.5s-8.5 6.5-7.5 12" stroke="#8A2BE2" strokeWidth="1.1" strokeLinecap="round" fill="none" opacity="0.9" />
        </g>

        <g stroke="#00F0FF" strokeOpacity="0.35" strokeWidth="0.7" fill="none">
        ...
        <g fill="#00F0FF" fillOpacity="0.28" fontFamily="ui-monospace, monospace" fontSize="5.2">
      ...
      <div
        className="pointer-events-none absolute inset-[8%] z-0 rounded-full bg-[radial-gradient(circle_at_50%_40%,rgba(0,240,255,0.18),transparent_55%),radial-gradient(circle_at_60%_70%,rgba(138,43,226,0.16),transparent_50%)] animate-pulse"
        aria-hidden
      />
    </div>
  );
