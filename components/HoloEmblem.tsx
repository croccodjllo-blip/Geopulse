...
export function HoloEmblem({
  ...
  return (
    ...
    >
      ...
      <div
        className="pointer-events-none absolute inset-[8%] z-0 rounded-full bg-[radial-gradient(circle_at_50%_40%,rgba(201,211,221,0.18),transparent_55%),radial-gradient(circle_at_60%_70%,rgba(91,107,122,0.16),transparent_50%)] animate-pulse"
        aria-hidden
      />
    </div>
  );
