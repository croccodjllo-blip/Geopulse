#!/usr/bin/env python3
"""Upsert native checkout/waiver/UI gettext strings and compile .mo catalogs."""
...
LOCALES = {
    "en": (ROOT / "translations/en/LC_MESSAGES/messages.po", "EN", "checkout_ui_i18n_en_de_es.py"),
    "de": (ROOT / "translations/de/LC_MESSAGES/messages.po", "DE", "checkout_ui_i18n_en_de_es.py"),
    "es": (ROOT / "translations/es/LC_MESSAGES/messages.po", "ES", "checkout_ui_i18n_en_de_es.py"),
    "zh": (ROOT / "translations/zh_Hans/LC_MESSAGES/messages.po", "ZH", "checkout_ui_i18n_zh_ko.py"),
    "ko": (ROOT / "translations/ko/LC_MESSAGES/messages.po", "KO", "checkout_ui_i18n_zh_ko.py"),
}
